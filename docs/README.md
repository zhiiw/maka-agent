...
- [Git-native managed workspace roadmap](./architecture/runtime-resume-git-native-workspace-roadmap.zh-CN.md)
- [Runtime resume extraction ledger](./architecture/runtime-resume-extraction-ledger.zh-CN.md)
- [Runtime resume Phase 3–4 extraction history](./architecture/runtime-resume-phase3-phase4-workspace-checkpoint-design.zh-CN.md)
