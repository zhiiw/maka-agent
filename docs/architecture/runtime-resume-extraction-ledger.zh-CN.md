...
| `storage/sqlite-runtime-store.ts` | atomic baseline bundle、root binding、read cross-check、rebuild、failpoints |
...
- DB rootId exact binding、unbound operational data fail closed；
