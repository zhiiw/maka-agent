export const RECOVERY_TEST_INVENTORIES = Object.freeze({
  'managed-workspace': Object.freeze({
    ...
    testNamePattern:
      'real process crash|real process is killed|real crash|real-process crash|crash after baseline ref publication',
    ...
    expectedByPlatform: Object.freeze({
      darwin: Object.freeze({ tests: 14, pass: 14, skipped: 0 }),
