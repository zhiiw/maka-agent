...
test('the Gitoxide gate owns repository admission changes', () => {
  ...
  for (const path of [
    ...
    'packages/runtime-host/src/server/workspace-resolver.ts',
    ...
    'packages/runtime-host/src/__tests__/connect-or-spawn-env.test.ts',
    ...
    'packages/runtime-host/src/__tests__/execution-composition-factory.test.ts',
    'packages/runtime-host/src/__tests__/managed-files-dev-bootstrap.test.ts',
    'packages/runtime-host/src/test-only/managed-files-dev-bootstrap.ts',
    'packages/runtime-host/src/test-only/managed-files-candidate-main.ts',
