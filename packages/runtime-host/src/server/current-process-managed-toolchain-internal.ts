...
interface ManagedCommandToolchainManifestV4 {
  readonly schemaVersion: 4;
  readonly protocol: 'maka_managed_command_toolchain_release_v4';
  ...
  readonly allowedEffectClasses: readonly [
...
function decodeManifest(input: unknown): ManagedCommandToolchainManifestV4 {
  ...
  if (
    ...
    value.protocol !== 'maka_managed_command_toolchain_release_v4' ||
    ...
    value.allowedEffectClasses.length !== 3 ||
    value.allowedEffectClasses[0] !== 'hermetic_observation_v2' ||
    value.allowedEffectClasses[1] !== 'hermetic_observation_v3' ||
    value.allowedEffectClasses[2] !== 'workspace_transform_v1' ||
    value.distributionReady !== true
  ) {
    throw invalidManifest('Managed command toolchain manifest is invalid');
  }
  return value as unknown as ManagedCommandToolchainManifestV4;
}
