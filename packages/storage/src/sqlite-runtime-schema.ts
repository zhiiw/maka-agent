...
const MIGRATIONS: ReadonlyMap<number, string> = new Map([
  ...
  [
    11,
    `
    ALTER TABLE runtime_workspace_heads RENAME TO runtime_workspace_heads_v10;
    ALTER TABLE runtime_workspace_versions RENAME TO runtime_workspace_versions_v10;
    ...
    SELECT
      ...
      tree_delta_digest, changed_file_count, deleted_file_count,
      accepted_event_id, protocol_version, committed_at
    FROM runtime_workspace_versions_v10;
    ...
    SELECT * FROM runtime_workspace_heads_v10;

    DROP TABLE runtime_workspace_heads_v10;
    DROP TABLE runtime_workspace_versions_v10;
    `,
  ],
]);
